...
export const productsDB: IProduct[] = [
    ...
    },
    {
        ...
        characteristicsDetail: [
            {
                code: "Características generales",
                info: [
                    {
                        title: "Marca",
                        description: "Philco"
        ...
        Utilizalo para las aplicaciones que desees. Al ser percutor y destornillador podrás explotar al máximo sus funciones y obtener exactitud y calidad.`,
        stock: 412,
        sold: 120,
        created: 2131123213123123,
        offer: true,
